class CardToggle extends HTMLElement {
    ...
    _injectStyles() {
        ...
        style.textContent = `
            ...
            card-toggle[dashed][color="stone"]     { border-color: rgba(112,144,168,0.55); }
            ...
            card-toggle[color="stone"]:hover {
                background-color: rgba(112, 144, 168, 0.05);
                box-shadow: 0 0 0 1px rgba(112, 144, 168, 0.2);
            }
